...
export default function NavBar() {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="bg-[#fe0600] h-16 p-2 fixed top-0 left-0 w-full z-50 shadow-lg flex items-center">
        <div className="container mx-auto flex items-center justify-between px-4">
          ...
          <Link href="/" className="flex items-center">
            <Image
              ...
              width={120}
              height={40}
              className="h-12 w-auto" // Ensures the image doesn't exceed navbar height
            />
          </Link>
